...
import com.aplicaciones.pedidosapp.databinding.ActivityAccountRecoveryBinding
        ...
        binding.senEmailAppCompatButton.setOnClickListener{
            ...
            Firebase.auth.sendPasswordResetEmail(emailAddress).addOnCompleteListener { task->
                if (task.isSuccessful){
                    ...
                    Toast.makeText(this, "Ingrese un email de cuenta valida", Toast.LENGTH_SHORT).show()
                }
